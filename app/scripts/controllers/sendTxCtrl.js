...
var sendTxCtrl = function($scope, $sce, walletService, $rootScope) {
    ...
    $scope.sendTx = function() {
        ...
        uiFuncs.sendTx($scope.signedTx, function(resp) {
            if (!resp.isError) {
                var checkTxLink = "https://wallet.shaft.com?txHash=" + resp.data + "#check-tx-status";
                ...
                var emailBtn = '<a class="btn btn-xs btn-info " href="mailto:contact@shaft.sh?Subject=Issue%20regarding%20my%20TX%20&Body=' + emailBody + '" target="_blank" rel="noopener">Confused? Email Us.</a>';
